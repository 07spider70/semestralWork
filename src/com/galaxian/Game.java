...
public class Game extends Canvas implements Commons, KeyListener, Runnable {
	...
	public void initGame() {
		...
		//container.addKeyListener((KeyListener) new GameController());
	...
	static class UpAction extends AbstractAction {
		...
		public void actionPerformed(ActionEvent tf) {
			System.out.println("Up bolo stlacene");
		}
	}
	...
	public void run() {
		...
		//vnorena trieda pre kontrolu pohybu hraca//pocet klaves ktore treba stlacit kym cakame na hocijaky klaves obrazovka
